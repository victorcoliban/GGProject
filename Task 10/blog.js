...
const addPost = () => {
    let newArray = [...array];
    newArray.push({id: "6", title: "post01", description: "description of post01", date: "31/01/2022", image: "post01.jpg"},
...
const changePost = () => {
    let newArray = [...array];
    newArray[1].title = "Second blog post";
    console.log(newArray)
}
...
//     console.log(array.map(function(element) { return element.date; }).sort().reverse()[0]);
// }
